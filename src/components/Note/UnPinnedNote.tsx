...
const UnPinnedNote = ({
  ...
  return (
    ...
    >
      ...
      >
        <span className="bg-purple-300 shadow rounded-2xl p-4">UnPinned Note of page {page}</span>
      </h1>
          ...
          >
            ...
            >
              <div className="py-4 bg-yellow-100 px-6 flex items-start justify-between w-full">
                ...
                <div className="w-10/12 pl-2">
                  <p className="focus:outline-none font-semibold leading-normal text-xl text-gray-800">{Note.title}</p>
                </div>
                {/* pin button */}
                <button
                  onClick={() => {
            ...
            <div className="bg-gray-100 px-6 py-1 text-right">
              <p className="focus:outline-none text-sm leading-normal pt-2 text-gray-500">
                Last updated in: {Note.date} at <span className="text-black font-normal">{Note.time}</span>
              </p>
